...
print("Loading model...")
model = YOLO("./Models/Traffic_Sign_model_v1/Road_Sign_Detection.pt")
...
results = model(source="./Sample_images/footage_1.mp4", show=True, conf=0.4)


# Define Video input
# # vid = cv2.VideoCapture("./Testing/traffic-sign-to-test.mp4")
# vid = cv2.VideoCapture("./Sample_images/footage_1.mp4")
...
#     if ret:
#         results = model(img, stream=True, confidence=0.4)
